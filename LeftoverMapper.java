...
/*
public class LeftoverMapper extends Mapper<IntWritable, Node, IntWritable, NodeOrDouble> {
    public void map(IntWritable key, Node value, Context context) throws IOException, InterruptedException {
        ...
        if(value.outgoing.length == 0) {
        	...
        	context.getCounter(Counter.counters.DANGLINGNODE).increment((long)value.pageRank*10000);
        }
